<div class="row-fluid breadcrumbs margin-bottom-40">
 ...
 <li class="dropdown">
               ...
               <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                   <li>
                            <a href=<?php echo site_url('clubs/get_list_of_clubs_luxury') ?>  class="list-group-item"
                               id="left_sider">Luxury<span class="badge pull-right"
                                                           id="counter">19</span></a></li>
                        <li>
                            <a href=<?php echo site_url('clubs/get_list_of_clubs_standard') ?>  class="list-group-item"
                               id="left_sider">Standard<span class="badge pull-right"
                                                             id="counter">19</span></a></li>
                        <li>
                            <a href=<?php echo site_url('clubs/get_list_of_clubs_medium') ?>  class="list-group-item"
                               id="left_sider">Medium<span class="badge pull-right"
                                                           id="counter">19</span></a></li>
                        <li>
                            <a href=<?php echo site_url('clubs/get_list_of_clubs_ordinary') ?>  class="list-group-item"
                               id="left_sider">Ordinary<span class="badge pull-right"
                                                             id="counter">19</span></a></li>
                        <li>
                            <a href=<?php echo site_url('clubs/get_list_of_clubs_low') ?>  class="list-group-item"
