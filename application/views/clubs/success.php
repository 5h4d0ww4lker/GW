<?php if ($club_detail): ?>
    <?php foreach ($club_detail as $row): ?>
        ...
        <div class="container min-hight">
            <div class="row-fluid">
                <div class="span9">
                    <h2>You Successfully send A Reservation Request to <?= $row->club_name ?></h2>
                    ...
                    <ul class="unstyled">
                        ...
                        <li><i class="icon-ok-circle"></i>If Money Is Not delivered as promised  Neither <?= $row->club_name ?> nor 2hagerbet.com will take responsibility for the inconvenience.</li>
