<div class="content-wrapper">
    ...
    <section class="invoice">
        ...
        <div class="row invoice-info">
            ...
            <div class="col-sm-4 invoice-col">
                ...
                <address>
                    ...
                    <strong> Phone:</strong> <?= $row->hotel_phone_mobile ?><br/>
                        <strong>Email: </strong><?= $row->hotel_email ?><br/>
                </address>
            </div><!-- /.col -->
            <div class="col-sm-4 invoice-col">
        ...
        <div class="row no-print">
            <div class="col-xs-12">
                <a href=<?php echo site_url('hag22673627bet8001niki1base5621ac/printrs/' . $row->request_id) ?> target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Print</a>
            </div>
        </div>
    </section><!-- /.content -->
