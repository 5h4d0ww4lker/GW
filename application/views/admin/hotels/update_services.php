<?php if ($company_list): ?>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
 <form method="post"
                                      action="<?php echo base_url('index.php/hag22673627bet8001niki1base5621ac/update_serv') ?>">
                                    <div class="box-body">

                                        <input class="hidden" type="hidden" value=" <?= $row->hotel_id ?> "  name="hotel_id">

                                        <label>Parking</label>
                                        <input class="form-control" type="text" value="<?= $row->hotel_parking ?>"  name="hotel_parking1" maxlength="100" required="required">
 ...
 <label>Meeting Hall</label>
                                        ...
                                        <input class="form-control" type="text" value=" <?= $row->hotel_children_play_ground ?>" name="hotel_children_play_ground1" maxlength="100" required="required">
                        ...
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
                                ...
                                <table class="table table-bordered table-striped">
                                        ...
                                        <input class="form-control" type="text" value=" <?= $row->hotel_conference_room ?>" name="hotel_conference_room1" maxlength="100" required="required">

                                         <label>Wi-Fi</label>
                                        <input class="form-control" type="text" placeholder="Email" name="hotel_wifi" value=" <?= $row->hotel_wifi ?>" maxlength="100" required="required">
