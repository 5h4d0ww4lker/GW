                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li> <a xlass="hidden" href=<?php echo site_url('hag22673627bet8001niki1base5621ac/booking_enquiries/' . $row->hotel_id) ?>>Pending Payment</a></li>
                            <li> <a xlass="hidden" href=<?php echo site_url('hag22673627bet8001niki1base5621ac/booking_enquiries/' . $row->hotel_id) ?>>Canceled</a></li>
                            <li> <a xlass="hidden" href=<?php echo site_url('hag22673627bet8001niki1base5621ac/booking_enquiries/' . $row->hotel_id) ?>>Approved</a></li>
                            <li> <a xlass="hidden" href=<?php echo site_url('hag22673627bet8001niki1base5621ac/booking_enquiries/' . $row->hotel_id) ?>>Completed</a></li>
                        </ul>
                    </li>
