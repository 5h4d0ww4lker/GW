                            ...
                            <div class="box-body">
                                ...
                                <div class="box-header">
                                    ...
                                    <a
                                        ...
                                        href=<?php echo site_url('hag20637210001nikki5621001101basepath33cac/delete_event/' . $row->event_id) ?>><span class="glyphicon glyphicon-trash"></span>&nbsp;Delete</a>

                                    <a
                                        class="btn btn-success bg-light-blue-active btn-flat" id="visit"
                                        href=<?php echo site_url('hag20637210001nikki5621001101basepath33cac/update_event/' . $row->event_id) ?>><span class="glyphicon glyphicon-edit"></span>&nbsp;Change Status</a></a>
