<div class="content-wrapper">
    ...
    <div class="pad margin no-print">
        <div class="" style="margin-bottom: 0!important;">
            <a
                ...
                href=<?php echo site_url('hag20637210001nikki5621001101basepath33cac/update_request_status/' . $row->request_id) ?>><span class="glyphicon glyphicon-edit"></span>&nbsp;Change Status</a></a>
    ...
    <section class="invoice">
        ...
        <div class="row invoice-info">
            ...
            <div class="col-sm-4 invoice-col">
                ...
                <address>
                    ...
                    <strong> Phone:</strong> <?= $row->club_phone_mobile ?><br/>
                        <strong>Email: </strong><?= $row->club_email ?><br/>
                </address>
            </div><!-- /.col -->
            <div class="col-sm-4 invoice-col">
        ...
        <div class="row no-print">
            <div class="col-xs-12">
                <a href=<?php echo site_url('hag20637210001nikki5621001101basepath33cac/printrs/' . $row->request_id) ?> target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Print</a>
            </div>
        </div>
    </section><!-- /.content -->
