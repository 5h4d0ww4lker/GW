                        ...
                        <div class="box box-info">
                            ...
                            <div class="box box-info">
                                ...
                                <div class="box-body">
                                    ...
                                    <form method="post"
                                          action="<?php echo base_url('index.php/hag20637210001nikki5621001101basepath33cac/update_bos') ?>">
                                        <div class="box-body">


                                            <input class="hidden" type="hidden" value=" <?= $row->reservation_id ?> "  name="reservation_id" value="<?= $row->status ?>">
