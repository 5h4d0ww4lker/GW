<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Events More</li>
        </ol>
    </section>
    <br/>
                            ...
                            <div class="box-body">
                                ...
                                <div class="box-header">
                                    ...
                                    <a
                                        ...
                                        href=<?php echo site_url('hag70178731nikki5362045182basepath66321097reac/delete_event/' . $row->event_id) ?>><span class="glyphicon glyphicon-trash"></span>&nbsp;Delete</a>

                                    <a
                                        class="btn btn-success bg-light-blue-active btn-flat" id="visit"
                                        href=<?php echo site_url('hag70178731nikki5362045182basepath66321097reac/update_event/' . $row->event_id) ?>><span class="glyphicon glyphicon-edit"></span>&nbsp;Change Status</a></a>
