...
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        <form method="post" action="<?php echo base_url('index.php/hag70178731nikki5362045182basepath66321097reac/login_process') ?>">
        ...
        <a href=<?php echo site_url('hag70178731nikki5362045182basepath66321097reac/register') ?>>|Register</a>
