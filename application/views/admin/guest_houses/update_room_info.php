            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body">
                            <form method="post"
                                  action="<?php echo base_url('index.php/hag700021672362217nikki53600228basep12873gac/update_ri') ?>">
                            <table id="example2" class="table table-bordered table-hover table-responsive">
                                ...
                                <tbody>
                                <tr>
                                    <td> <input class="form-control" type="text" value=" <?= $row->free_twin_room ?> " name="free_twin_room1" maxlength="4"> </td>
