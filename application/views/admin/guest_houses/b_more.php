<div class="content-wrapper">
    ...
    <div class="pad margin no-print">
        <div class="" style="margin-bottom: 0!important;">
            <a
                ...
                href=<?php echo site_url('hag700021672362217nikki53600228basep12873gac/update_booking_status/' . $row->booking_id) ?>><span class="glyphicon glyphicon-edit"></span>&nbsp;Change Status</a></a>
    ...
    <section class="invoice">
        ...
        <div class="row invoice-info">
            ...
            <div class="col-sm-4 invoice-col">
                ...
                <address>
                    ...
                    Phone: <?= $row->hotel_phone_mobile ?><br/>
                    Email: <?= $row->hotel_email ?><br/>
                </address>
            </div><!-- /.col -->
            <div class="col-sm-4 invoice-col">
        ...
        <div class="row no-print">
            <div class="col-xs-12">
                <a href=<?php echo site_url('hag700021672362217nikki53600228basep12873gac/prints/' . $row->booking_id) ?> target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Print</a>
                </div>
        </div>
    </section><!-- /.content -->
