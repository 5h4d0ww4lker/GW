                            ...
                            <div class="box-body">
                                ...
                                <div class="box-header">
                                    ...
                                    <a
                                        ...
                                        href=<?php echo site_url('hag700021672362217nikki53600228basep12873gac/delete_event/' . $row->event_id) ?>><span class="glyphicon glyphicon-trash"></span>&nbsp;Delete</a>

                                    <a
                                        class="btn btn-success bg-light-blue-active btn-flat" id="visit"
                                        href=<?php echo site_url('hag700021672362217nikki53600228basep12873gac/update_event/' . $row->event_id) ?>><span class="glyphicon glyphicon-edit"></span>&nbsp;Change Status</a></a>
