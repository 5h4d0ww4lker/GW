...
<div class="row">
                ...
                <div>
                    ...
                    <a href=<?php echo site_url('readmin_controller/login') ?> class="btn-flat btn-block btn btn-primary bg-maroon-active" class="text-bold">Resort</a>
                    <a href=<?php echo site_url('hag700021672362217nikki53600228basep12873gac/login') ?> class="btn-flat btn-block btn btn-primary bg-purple-active" class="text-bold">Guest House</a>
