                    ...
                    <div class="col-md-6">
                        ...
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
                                ...
                                <form method="post"
                                      action="<?php echo base_url('index.php/hag700021672362217nikki53600228basep12873gac/update_rp') ?>">
                                    <div class="box-body">
                                        ...
                                        <input class="form-control" type="text" value=" <?= $row->guest_house_single_room_price ?>" name="guest_house_single_room_price1" maxlength="10">

                                          <label>Twin Room</label>
                                        <input class="form-control" type="text" value=" <?= $row->guest_house_twin_room_price ?>" name="guest_house_twin_room_price1" maxlength="10">
                            ...
                            <div class="box-body">
                                ...
                                <table class="table table-bordered table-striped">
                                 ...
                                 <label>Suit Room</label>
                                        <input class="form-control" type="text" value="<?= $row->guest_house_suit_room_price ?>"  name="guest_house_suit_room_price1" maxlength="10">


                                        <label>Presidential Suit</label>
                                        <input class="form-control" type="text" value=" <?= $row->guest_house_presidential_suit_price ?>" name="guest_house_presidential_suit_price1" maxlength="10">
