                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
 <form method="post"
                                      action="<?php echo base_url('index.php/hag38926610027834202nikki626basepath645rac/update_rserv') ?>">
                                    <div class="box-body">
                                        ...
                                        <input class="form-control" type="text" value=" <?= $row->restaurant_special ?>" name="restaurant_special1">
