                            ...
                            <div class="box-body">
                                ...
                                <div class="box-header">
                                    ...
                                    <a
                                        ...
                                        href=<?php echo site_url('hag38926610027834202nikki626basepath645rac/delete_event/' . $row->event_id) ?>><span class="glyphicon glyphicon-trash"></span>&nbsp;Delete</a>

                                    <a
                                        class="btn btn-success bg-light-blue-active btn-flat" id="visit"
                                        href=<?php echo site_url('hag38926610027834202nikki626basepath645rac/update_event/' . $row->event_id) ?>><span class="glyphicon glyphicon-edit"></span>&nbsp;Change Status</a></a>
