                            ...
                            <div class="box-body">
                                ...
                                <div class="box-header">
                                    ...
                                    <a
                                        ...
                                        href=<?php echo site_url('admin_controller/delete_reservation/' . $row->reservation_id) ?>><span class="glyphicon glyphicon-trash"></span>&nbsp;Delete</a>

                                    <a
                                        class="btn btn-success bg-light-blue-active btn-flat" id="visit"
                                        href=<?php echo site_url('admin_controller/update_reservation_status/' . $row->reservation_id) ?>><span class="glyphicon glyphicon-edit"></span>&nbsp;Change Status</a></a>
