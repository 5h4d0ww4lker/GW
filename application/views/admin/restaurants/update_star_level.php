                        ...
                        <div class="box box-info">
                            ...
                            <div class="box box-info">
                                ...
                                <div class="box-body">
                                    ...
                                    <form method="post"
                                          action="<?php echo base_url('index.php/hag38926610027834202nikki626basepath645rac/update_sl') ?>">
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                <label>Select</label>
                                                <select class="form-control" name="restaurant_class1" value="<?= $row->restaurant_class ?>">
