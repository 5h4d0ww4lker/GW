    ...
    <div class="row-fluid">
        ...
        <div class="span7">
            <div class="row-fluid margin-bottom-20">
                ...
                <div class="span6 service-box-v1">
                    <img src="<?php echo base_url(); ?><?= $row->conference_room_image ?>"
                         id="lol">
        ...
        <div class="span5">
            ...
            <form method="post"
                  action="<?php echo base_url('index.php/restaurants/add_contact') ?>" class="form-horizontal">
