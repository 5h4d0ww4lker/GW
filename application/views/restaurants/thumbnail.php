                                    ...
                                    <div class="row-fluid margin-bottom-40">
                                        ...
                                        <div class="span3 pricing pricing-active">
                                            ...
                                            <div class="pricing-footer">
                                                ...
                                                <a href=<?php echo site_url('restaurants/reservation/' . $row->restaurant_id) ?> class="btn green">Reserve Now<i class="m-icon-swapright m-icon-white"></i></a>
