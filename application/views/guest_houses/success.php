<?php if ($guest_house_detail): ?>
    <?php foreach ($guest_house_detail as $row): ?>
        ...
        <div class="container min-hight">
            <div class="row-fluid">
                <div class="span9">
                    <h2>You Successfully send A Booking Enquiry to <?= $row->guest_house_name ?></h2>
                    ...
                    <ul class="unstyled">
                        ...
                        <li><i class="icon-ok-circle"></i>If Money Is Not delivered as promised  Neither <?= $row->guest_house_name ?> nor 2hagerbet.com will take responsibility for the inconvenience.</li>
                        <li><i class="icon-ok-circle"></i>Sending False enquiries will led to serious accusation and punishable by law.</li>
                        <li><i class="icon-ok-circle"></i>Thanx For Choosing   <?= $row->guest_house_name ?></li>

                    </ul>

                    For More Information Call<br/>
                    <?= $row->guest_house_name ?><br/>
                    <?= $row->guest_house_phone_mobile ?>/<?= $row->guest_house_phone_office ?>
