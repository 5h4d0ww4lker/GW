...
<div class="margin-bottom-30">
    ...
    <form method="post" action="<?php echo base_url('index.php/guest_houses/check_availablity') ?>">
        <select class="form-control" name="guest_house_city" id="liststr">
        ...
        <select class="form-control" name="guest_house_location" id="liststr">
        ...
        <button type="submit" class="btn green">Search Now</button>
                    ...
                    <div class="span5">
                        ...
                        <p>This Rooms availablity searcher helps you to get the appropeiate and desiered accomodation places within your own search parameters. You can use diiferent parameters for searching guest_houses like star level. city, location, room prices, free available rooms, room type and other. Thanx For choosing 2hagerbet.com</p>
