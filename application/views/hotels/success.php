<?php if ($hotel_detail): ?>
    <?php foreach ($hotel_detail as $row): ?>
        ...
        <div class="container min-hight">
            <div class="row-fluid">
                <div class="span9">
                    <h2>You Successfully send A Booking Enquiry to <?= $row->hotel_name ?></h2>
                    ...
                    <ul class="unstyled">
                        ...
                        <li><i class="icon-ok-circle"></i>If Money Is Not delivered as promised  Neither <?= $row->hotel_name ?> nor 2hagerbet.com will take responsibility for the inconvenience.</li>
                        <li><i class="icon-ok-circle"></i>Sending False enquiries will led to serious accusation and punishable by law.</li>
                        <li><i class="icon-ok-circle"></i>Thanx For Choosing   <?= $row->hotel_name ?></li>

                    </ul>

                    For More Information Call<br/>
                    <?= $row->hotel_name ?><br/>
                    <?= $row->hotel_phone_mobile ?>/<?= $row->hotel_phone_office ?>
