...
<div class="margin-bottom-30">
    ...
    <form method="post" action="<?php echo base_url('index.php/hotels/check_availablity') ?>">
        ...
        <select class="form-control" name="star_level" id="liststr">
            ...
            <option id="sel" value="5 Star">5 star</option>
            <option id="sel" value="4 Star">4 Star</option>
            <option id="sel" value="3 Star">3 Star</option>
            <option id="sel" value="2 Star">2 Star</option>
            <option id="sel" value="1 Star">1 Star</option>
        </select>&nbsp;&nbsp;&nbsp;&nbsp;

        <select class="form-control" name="rooms_from" id="liststr">
        ...
        <select class="form-control" name="available_room_types" id="liststr">
            ...
            <option id="sel" value="suit room">Suit Room</option>
            <option id="sel" value="single room">Single Room</option>
            <option id="sel" value="twin room">Twin Room</option>
            <option id="sel" value="presidential">Presidential</option>
            <option id="sel" value="special">Special</option>
        </select>
        <br/> <br/>
        <button type="submit" class="btn green">Search Now</button>
                    ...
                    <div class="span5">
                        ...
                        <p>This Rooms availablity searcher helps you to get the appropeiate and desiered accomodation places within your own search parameters. You can use diiferent parameters for searching hotels like star level. city, location, room prices, free available rooms, room type and other. Thanx For choosing 2hagerbet.com</p>
                ...
                <div class="recent-news margin-bottom-10">
                    <div class="row-fluid margin-bottom-10">
                        ...
                        <div class="span9 recent-news-inner">
                            ...
                            <p>Free For 3 months trial period.</p>
                        </div>                        
                    </div>
                    <div class="row-fluid margin-bottom-10">
                        <div class="span3">
        ...
        <div class="row-fluid front-team">
            ...
            <ul class="thumbnails">
                <li class="span3 space-mobile">
                    <img src="<?php echo base_url(); ?>advert/adv big.jpg" alt="">
                    <h3>
                        <a>Advertise Here</a> 
