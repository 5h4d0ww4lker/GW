...
<div class="container min-hight">
    <div class="row-fluid">
        <div class="span9">
            <h2>You successfully send a service request to <?= $row->hotel_name ?></h2>
            ...
            <ul class="unstyled">
                ...
                <li><i class="icon-ok-circle"></i> Neither <?= $row->hotel_name ?> nor 2hagerbet.com will give guaranty for each individual requests.</li>
